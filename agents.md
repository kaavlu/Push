...
- Live writes to social graph (friends/groups/sharing), realtime/subscriptions — profile self-writes (basics, toggles, availability), push coordination (create/edit/cancel/delete, RSVP), and friend-request coordination (search/send/accept/deny via `0009`) are allowed
