...
- Live writes to social graph (friends/groups/sharing), realtime/subscriptions — profile self-writes (basics, toggles, availability) and push coordination (create/edit/cancel/delete, RSVP) are allowed
