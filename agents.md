...
- Live writes to social graph (friends/groups/pushes/sharing), realtime/subscriptions — profile self-writes (basics, toggles, availability) are allowed
