...
**Design system (Issue #63):** Open **`docs/design-system.md`** before adding UI chrome. Code home: `Push/DesignSystem/`. Decisions: `tasks/design-system-decision-log.md`. Spec/waves: `docs/superpowers/specs/2026-07-21-push-design-system-specification.md`. Handoff: `tasks/design-system-handoff.md`. Named surfaces only; primaries are solid sunbeam or glass+walnut rim only; generic circular utility → `PushCircleIconButton`. Preserve approved appearance.
