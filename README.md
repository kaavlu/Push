...
- **Social providers** (Google on welcome + sign-in) — wired to Supabase Auth (OAuth web session); requires dashboard provider config. Sign in with Apple is disabled for Personal Team provisioning.
